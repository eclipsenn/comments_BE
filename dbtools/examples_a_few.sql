...
INSERT INTO entities(type, creator, user_last_modified, text, ancestor_id) VALUES('comment', 'user1', 'user1', 'dima commented some comment', 3);
INSERT INTO entities(type, creator, user_last_modified, text, ancestor_id) VALUES('comment', 'user2', 'user2', 'yana commented some comment', 4);
